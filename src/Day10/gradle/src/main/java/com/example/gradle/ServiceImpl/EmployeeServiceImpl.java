...
import com.example.gradle.kafka.EmployeeKafkaProducer;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeServiceImpl(EmployeeRepository repository, EmailFeignClient emailFeignClient,EmployeeKafkaProducer employeeKafkaProducer,RestTemplate restTemplate,WebClient emailWebClient) {
    ...
    public EmployeeDto addEmployee(EmployeeDto employeeDto) {
        ...
        employeeKafkaProducer.sendEmployeeCreatedEvent(employeeDto);
